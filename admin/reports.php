...
// Hybrid rollout: route admin reports UI to Next.js when enabled.
$nextAdminReportsUrl = nextjs_url('/admin/reports');
if (feature_enabled('nextjs_admin_reports') && $nextAdminReportsUrl !== '') {
    redirect($nextAdminReportsUrl);
}
